...
diff --git a//dev/null b/Delphi LogIn/Unit1.pas	
index 0000000000000000000000000000000000000000..f26a67b7f6aa1ed9ff5cd7ffb8475bbe5deacfb5 100644
--- a//dev/null
+++ b/Delphi LogIn/Unit1.pas	
@@ -0,0 +1,128 @@
+unit Unit1;
+
+interface
...
+begin
+  LDatabasePath := IncludeTrailingPathDelimiter(ExtractFilePath(ParamStr(0))) + 'users.db';
+
+  if FDConnection1.Connected then
+    FDConnection1.Connected := False;
+
+  FDConnection1.Params.Database := LDatabasePath;
...
+    FDQuery1.ExecSQL;
+
+    FDQuery1.ParamByName('u').AsString := 'kosta';
+    FDQuery1.ParamByName('p').AsString := '12312';
+    FDQuery1.ExecSQL;
+
